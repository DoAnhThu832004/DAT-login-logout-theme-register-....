...
fun AddAlbumScreen(
    ...
    var shouldAnimated by rememberSaveable { mutableStateOf(true) }
    var name by remember { mutableStateOf("") }
    var description by remember { mutableStateOf("") }
    BoxWithConstraints {
        val startOffset = maxWidth
        val alphaAnim = remember { androidx.compose.animation.core.Animatable(0f) }
        val slideAmin = remember { androidx.compose.animation.core.Animatable(startOffset.value) }
